"""
Django settings for fleetcor_routemaste_45676 project.
...
ROOT_URLCONF = 'fleetcor_routemaste_45676.urls'
...
WSGI_APPLICATION = 'fleetcor_routemaste_45676.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fleetcor_routemaste_45676 API",
    "DESCRIPTION": "API documentation for fleetcor_routemaste_45676 App",
    "VERSION": "v1",
}
